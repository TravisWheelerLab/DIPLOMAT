...
class VideoController(wx.Panel):
    ...
    def __init__(self, parent, video_player: VideoPlayer, w_id = wx.ID_ANY, pos = wx.DefaultPosition,
        ...
        self._sizer.Add(self._back_btn, 0, wx.ALIGN_CENTER | wx.EXPAND | wx.ALL)
        self._sizer.Add(self._play_pause_btn, 0, wx.ALIGN_CENTER | wx.EXPAND | wx.ALL)
        self._sizer.Add(self._stop_btn, 0, wx.ALIGN_CENTER | wx.EXPAND | wx.ALL)
        self._sizer.Add(self._forward_btn, 0, wx.ALIGN_CENTER | wx.EXPAND | wx.ALL)
