...
from diplomat.utils.frame_store_api import DLFSHeader, FrameReader, FrameWriter
import numpy as np
import h5py
...
class DLH5FSReader(FrameReader):
    """
    A Diplotmat Frame Store Reader. Allows for reading ".dlfs" files.
    """
...
class DLH5FSWriter(FrameWriter):
    """
    ...
    def __init__(
        ...
        self._header = DLFSHeader(*header.to_list())
