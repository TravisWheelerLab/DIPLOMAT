...
_marker_size_fallback = prefs["marker size"] if(isinstance(prefs["marker size"], int)) else 4

VISUAL_SETTINGS: ConfigSpec = {
    "pcutoff": (0.1, tc.RangedFloat(0, 1), "The probability to cutoff results below."),
    "dotsize": (_marker_size_fallback, int, "The size of the dots."),
    ...
    "skeleton": (None, Skeleton, "The skeleton to use for this this run of DIPLOMAT. Defaults to None, which uses the skeleton associated with the "
                                 "sleap project. Can be a list of strings, a list of tuples of strings, a dictionary of strings to strings or lists"
                                 "of strings, or True/False (True connects all parts, False connects no parts, disabling the skeleton).")
}
