...
class Predictor(ABC):
    ...
    def __init__(
        ...
        :param video_metadata: The metadata information for this diplomat instance. Most of these settings are primarily
                               useful to interactive plugins. Includes the keys:
                                ...
                                - :code:`"skeleton"`: None or a list of tuples of strings, specifying body parts to connect in a skeleton.
    ...
    def on_frames(self, scmap: TrackingData) -> Optional[Pose]:
        ...
        """
        raise RuntimeError(
            "Attempting to call on_frames before allocating resources (use a with statement)."
        )
    ...
    def on_end(self, progress_bar: ProgressBar) -> Optional[Pose]:
        ...
        """
        raise RuntimeError(
            "Attempting to call on_end before allocating resources (use a with statement)."
        )
    ...
    def get_description(cls) -> str:
        ...
        if cls.__doc__ is None:
            ...
            return " ".join(
                [s.strip() for s in cls.__doc__.split("\n") if (s.strip() != "")]
            )
